...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 1, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        ...
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        ...
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 6, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 6, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 5, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 7, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
